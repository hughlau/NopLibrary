...
namespace Nl.Services.Installation
{
    /// <summary>
    ...
    public partial class CodeFirstInstallationService : IInstallationService
    {
        ...
        {
            //duplicate of ValidateSeName method of \Nl.Services\Seo\UrlRecordService.cs (we cannot inject it here)
            if (entity == null)
        ...
        protected virtual void InstallScheduleTasks()
        {
            var tasks = new List<ScheduleTask>
            {
                new ScheduleTask
                {
                    Name = "Send emails",
                    Seconds = 60,
                    Type = "Nl.Services.Messages.QueuedMessagesSendTask, Nl.Services",
                    Enabled = true,
                    StopOnError = false
                },
                new ScheduleTask
                {
                    Name = "Keep alive",
                    Seconds = 300,
                    Type = "Nl.Services.Common.KeepAliveTask, Nl.Services",
                    Enabled = true,
                    StopOnError = false
                },
                new ScheduleTask
                {
                    Name = "Delete guests",
                    Seconds = 600,
                    Type = "Nl.Services.Customers.DeleteGuestsTask, Nl.Services",
                    Enabled = true,
                    StopOnError = false
                },
                new ScheduleTask
                {
                    Name = "Clear cache",
                    Seconds = 600,
                    Type = "Nl.Services.Caching.ClearCacheTask, Nl.Services",
                    Enabled = false,
                    StopOnError = false
                },
                new ScheduleTask
                {
                    ...
                    //60 minutes
                    Seconds = 3600,
                    Type = "Nl.Services.Logging.ClearLogTask, Nl.Services",
                    Enabled = false,
                    StopOnError = false
                },
                new ScheduleTask
                {
                    ...
                    //60 minutes
                    Seconds = 3600,
                    Type = "Nl.Services.Directory.UpdateExchangeRateTask, Nl.Services",
                    Enabled = true,
                    StopOnError = false
                }
            };
